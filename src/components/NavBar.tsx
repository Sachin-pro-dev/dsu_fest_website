...
function NavBar(props: { scroll: any }) {
    ...
    var refMob = useRef<any>();
    useEffect(() => {
        let handlerLeave = (e: any) => {
            if (refMob.current) {
                if (!refMob.current.contains(e.target)) {
                    setHover(false);
                }
            }
        }
        ...
        <div className="text-[#F8F9FA]">
                ...
                <div className="" ref={ref} >
                    <div className="">
                        <div className={`bg-[#343A40] h-[10vh] w-screen drop-shadow-md fixed ${!hover ? 'translate-y-0' : '-translate-y-full'} duration-75`}>
                            <div className={`flex h-full justify-between items-center`}>
                                ...
                                <div className="grid grid-cols-4 items-center w-[30vw]">
                                    <div className="w-[6vw] flex justify-center">
                                        <Link to={'/home'} onClick={props.scroll} >
                                            <div onClick={() => setHover(false)} className="grid grid-rows-2 justify-center items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 justify-self-center cursor-pointer hover:w-7 hover:h-7 transition-all">
                                    ...
                                    <div className="w-[6vw] flex justify-center">
                                        <Link to={'/events'} onClick={props.scroll} >
                                            <div onClick={() => setHover(false)} className="grid grid-rows-2 justify-center items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 justify-self-center cursor-pointer hover:w-7 hover:h-7 transition-all">
                                    ...
                                    {/* <div className="w-[6vw] flex justify-center">
                                        <Link to={'/artists'} onClick={props.scroll} >
                                            <div onClick={() => setHover(false)} className="grid grid-rows-2 justify-center items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 justify-self-center cursor-pointer hover:w-7 hover:h-7 transition-all">
                                    ...
                                    <div className="w-[6vw] flex justify-center">
                                        <Link to={'/contact'} onClick={props.scroll} >
                                            <div onClick={() => setHover(false)} className="grid grid-rows-2 justify-center items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 justify-self-center cursor-pointer hover:w-7 hover:h-7 transition-all">
                    ...
                    <div className="">
                        <div className={`bg-[#343A40] h-[15vh] w-screen drop-shadow-md text-[#F8F9FA] fixed ${hover ? 'translate-y-0' : '-translate-y-full'} duration-75 flex justify-between`}>
                            ...
                            <div className="grid grid-cols-3 h-[15vh] items-center w-[30vw]">
                                <Link to={'/home'} onClick={props.scroll} >
                                    <div onClick={() => setHover(false)} className="grid grid-rows-2 justify-center items-center">
                ...
                <div className="" ref={refTab}>
                    ...
                    <div className="">
                        <div className={`bg-[#343A40] h-fit w-screen drop-shadow-md text-[#F8F9FA] fixed ${hover ? 'translate-y-0' : '-translate-y-full'} duration-75 flex justify-between`}>
                            ...
                            <div className="flex justify-between items-center w-[35vw] px-2">
                                <Link to={'/home'} onClick={props.scroll} >
                                ...
                                <Link to={'/contact'} onClick={props.scroll} >
                                    <div onClick={() => setHover(false)} className="grid grid-cols-2 w-fit justify-center items-center">
                                        ...
                                        <div className="text-xs justify-self-center cursor-pointer -ml-2">Contact</div>
                                    </div>
                                </Link>
                            </div>
                        </div>
            ...
            {isTabletOrMobile && isPortrait &&
                <div className="" ref={refMob}>
                    ...
                    <div className="">
                        <div className={`bg-[#343A40] h-fit w-screen drop-shadow-md text-[#F8F9FA] fixed ${hover ? 'translate-y-0' : '-translate-y-full'} duration-75 flex justify-center`}>
                            <div className="grid grid-rows-3 items-center px-2 divide-y w-full">
                                <Link to={'/home'} onClick={props.scroll} >
                                    <div onClick={() => setHover(false)} className="grid grid-cols-2 w-full justify-center items-center m-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 justify-self-center cursor-pointer transition-all">
                                            <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                                            <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
                                        </svg>
                                ...
                                <Link to={'/events'} onClick={props.scroll} >
                                    <div onClick={() => setHover(false)} className="grid grid-cols-2 w-full justify-center items-center m-2">
                                        ...
                                        <div className="text-lg cursor-pointer">Events</div>
                                    </div>
                                </Link>
                                {/* <Link to={'/artists'} onClick={props.scroll} >
                                    <div onClick={() => setHover(false)} className="grid grid-cols-2 w-full justify-center items-center m-2">
                                        ...
                                        <div className="text-lg cursor-pointer">Artist</div>
                                    </div>
                                </Link> */}
                                <Link to={'/contact'} onClick={props.scroll} >
                                    <div onClick={() => setHover(false)} className="grid grid-cols-2 w-full justify-center items-center m-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 justify-self-center cursor-pointer transition-all">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                                        </svg>
