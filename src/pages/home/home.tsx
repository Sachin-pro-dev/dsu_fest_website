...
function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
      <div ref={refHead} className="relative h-[95vh] z-0">
        <div
          className={`flex justify-center relative ${
            isHeadVisible ? "opacity-100" : "opacity-25"
          } duration-700`}
        >
        ...
        <div className="absolute inset-0 z-10">
          <div className=" sm:flex w-screen flex-col justify-center items-center h-[95vh]  md:flex-row gap-44">
            ...
            <div className="h-[300px] bg-white w-[5px] rounded-md"></div>
      ...
      <div
        ref={refAbout}
        className="flex justify-center items-center h-fit py-8 shadow-md"
      >
        <div
          className={`${
            isAboutVisible
              ? "translate-x-0 opacity-100 scale-100"
              : "-translate-x-full opacity-25 scale-0"
          } duration-500`}
        >
          <div className="text-5xl flex justify-center my-5">About</div>
          <div
            className={`text-lg text-justify flex justify-center my-5 w-[90vw] text-1xl md:text-2xl ${
      ...
      <div ref={refevent} className="shadow-md">
        <div
          className={`m-5 ${
            isEventVisible ? "opacity-100 scale-100" : "opacity-0 scale-0"
          } duration-500`}
        >
